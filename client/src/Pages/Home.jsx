  ...
  const filteredData = (jobs, selected, query) => {
    ...
    if(selected){
      ...
      postingDate})=> 
          ...
          parseInt(maxPrice) <= parseInt(selected) || //less than or equal to selected salary
        ...
        {/* pagination */}
        {
          result.length > 0 ? (
            <div className='flex justify-center mt-4 space-x-8'>
              ...
              <button onClick={nextPage} disabled={currentPage === Math.ceil(filteredItems.length / itemsPerPage > itemsPerPage)} 
